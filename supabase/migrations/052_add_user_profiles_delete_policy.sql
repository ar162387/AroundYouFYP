-- ============================================================================
-- ADD USER PROFILES DELETE POLICY AND RECREATE USER PREFERENCE EMBEDDINGS
-- ============================================================================
-- 1. Adds DELETE RLS policy for user_profiles
-- 2. Drops and recreates all user_preference_embeddings related objects:
...
-- ============================================================================
-- DROP EXISTING USER PREFERENCE EMBEDDINGS OBJECTS
-- ============================================================================
...
-- Drop functions
DROP FUNCTION IF EXISTS public.search_user_preferences_by_similarity(UUID, vector(1536), INTEGER, NUMERIC);
DROP FUNCTION IF EXISTS public.update_user_preferences_updated_at();

-- Drop RLS policies for user_preference_embeddings
DROP POLICY IF EXISTS "Users can delete their own preference embeddings" ON public.user_preference_embeddings;
DROP POLICY IF EXISTS "Users can update their own preference embeddings" ON public.user_preference_embeddings;
DROP POLICY IF EXISTS "Users can insert their own preference embeddings" ON public.user_preference_embeddings;
DROP POLICY IF EXISTS "Users can view their own preference embeddings" ON public.user_preference_embeddings;
...
-- Drop indexes for user_preference_embeddings
DROP INDEX IF EXISTS public.idx_user_preference_embeddings_vector;
DROP INDEX IF EXISTS public.idx_user_preference_embeddings_preference_id;
DROP INDEX IF EXISTS public.idx_user_preference_embeddings_user_id;

-- Drop indexes for user_preferences
DROP INDEX IF EXISTS public.idx_user_preferences_confidence;
DROP INDEX IF EXISTS public.idx_user_preferences_user_preference_type;
DROP INDEX IF EXISTS public.idx_user_preferences_entity_type;
DROP INDEX IF EXISTS public.idx_user_preferences_preference_type;
DROP INDEX IF EXISTS public.idx_user_preferences_user_id;

-- Drop tables (this will cascade to any remaining dependencies)
DROP TABLE IF EXISTS public.user_preference_embeddings CASCADE;
DROP TABLE IF EXISTS public.user_preferences CASCADE;

-- ============================================================================
-- RECREATE USER PREFERENCES TABLE (Structured Data)
-- ============================================================================
...
-- ============================================================================
-- RECREATE USER PREFERENCE EMBEDDINGS TABLE (Vector Storage)
-- ============================================================================
...
-- ============================================================================
-- ADD USER PROFILES DELETE POLICY
-- ============================================================================
